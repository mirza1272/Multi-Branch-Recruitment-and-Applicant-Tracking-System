        ...
        <div style={{ background: C.bg, minHeight: '100vh', color: C.text, fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ height: '400px', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', animation: 'fadeInDown 0.8s ease-out' }}>
                    <h1 style={{ fontSize: '2.75rem', fontWeight: '900', letterSpacing: '-0.03em', textShadow: '0 4px 20px rgba(0,0,0,0.6)', margin: 0 }}>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12" style={{ marginTop: '-60px', position: 'relative', zIndex: 10 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '2.5rem', alignItems: 'start' }}>
                    ...
                    <div style={{ animation: 'fadeInLeft 0.6s ease-out' }}>
                        {/* Main Header Card */}
                        <div style={{ background: C.card, borderRadius: '20px', border: `1px solid ${C.border}`, padding: '2.5rem', marginBottom: '2rem', boxShadow: '0 20px 40px rgba(0,0,0,0.3)', position: 'relative', overflow: 'hidden' }}>
                        ...
                        {/* Description Content */}
                        <div style={{ background: C.card, borderRadius: '20px', border: `1px solid ${C.border}`, padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '2.5rem', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
                            <section>
                    ...
                    {/* Right Sidebar */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', animation: 'fadeInRight 0.6s ease-out' }}>
                        <button
                            onClick={() => {
                        ...
                        <div style={{ background: C.card, borderRadius: '16px', border: `1px solid ${C.border}`, padding: '1.75rem', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                {[
                                    ...
                                    { label: 'Location', val: job.location, icon: <MapIcon /> },
